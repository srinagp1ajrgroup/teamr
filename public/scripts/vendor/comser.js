...
ComSer.prototype.logout = function (username, callback){
...
ComSer.prototype.subscribe = function (username, callback)
{
...
ComSer.prototype.sendpresence = function (username, presence, cList, callback)
{
	if(username == undefined || username == null || username == "")
		return "Invalid Username"
...
ComSer.prototype.listen = function(callback){
	if(this.socket != null){
		...
		this.socket.on("privateChat", function(data){
			callback("privateChat", data);
		});

		this.socket.on("videochat", function(data){
...
ComSer.prototype.chathistory = function (username, fromid, toid, callback){
	...
	if(fromid == null || fromid == '' || fromid == undefined)
...
ComSer.prototype.removeAllListeners = function (){
    // this.socket.removeAllListeners();
}

// obj = {username: "srinagp", contactname:"vasuv" }
ComSer.prototype.searchuser = function (username, searchname, callback)
{
...
ComSer.prototype.getcontacts = function (username, callback){
	if(username == null || username == undefined || username == ""){
		return "Invalid Username"
	}
	var data = {username:username};
...
ComSer.prototype.sendContactreq = function (username, toname, toid, callback)
{
	...
	if(toname == null || toname == '' || toname == undefined)
		return "please enter valid toname";
...
ComSer.prototype.acceptContactreq = function (username, toname, recid, callback){
	...
	if(recid == null || recid == '' || recid == undefined){
		var errAlert = "please enter valid recid";
		return errAlert;
	}
